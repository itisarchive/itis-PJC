...
Repository that contains solutions to the exercises for the PJC (Programming in C and C++) practical classes, taught by
Filip Kwiatkowski during studies on [PJAIT](https://www.pja.edu.pl/en/).
...
repository [here](https://github.com/itisarchive/itis-PJC-PasswordManager).
